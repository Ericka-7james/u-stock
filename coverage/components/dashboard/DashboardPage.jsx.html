...
<head>
    <title>Code coverage report for components/dashboard/DashboardPage.jsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">components/dashboard</a> DashboardPage.jsx</h1>
        <div class='clearfix'>
            ...
            <div class='fl pad1y space-right2'>
                <span class="strong">63.09% </span>
                <span class="quiet">Branches</span>
                <span class='fraction'>53/84</span>
            </div>
...
<a name='L428'></a><a href='#L428'>428</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">// src/components/dashboard/DashboardPage.jsx
...
&nbsp;
  ...
  const mentionMap = useMemo(() =&gt; {
    const map = {};
    const data = Array.isArray(rawData) ? rawData : <span class="branch-1 cbranch-no" title="branch not covered" >[];</span>
    for (const item of data) {
<span class="cstat-no" title="statement not covered" >      if (!item?.ticker) <span class="cstat-no" title="statement not covered" >continue;</span></span>
<span class="cstat-no" title="statement not covered" >      map[item.ticker.toUpperCase()] = item.count;</span>
    }
    return map;
  }, [rawData]);
&nbsp;
  ...
  const allTickers = useMemo(() =&gt; {
    const data = Array.isArray(joinedRaw) ? joinedRaw : <span class="branch-1 cbranch-no" title="branch not covered" >[];</span>
    const set = new Set();
    for (const item of data) {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (!item?.ticker) <span class="cstat-no" title="statement not covered" >continue;</span>
...
&nbsp;
  const addTicker = (value) =&gt; {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!ticker) <span class="cstat-no" title="statement not covered" >return;</span>
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!allTickers.includes(ticker)) <span class="cstat-no" title="statement not covered" >return;</span>
    <span class="missing-if-branch" title="if path not taken" >I</span>if (selectedTickers.includes(ticker)) <span class="cstat-no" title="statement not covered" >return;</span>
...
&nbsp;
  ...
  const topIndexFund = useMemo(() =&gt; {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (best &amp;&amp; best.mentions &gt; 0) <span class="cstat-no" title="statement not covered" >return best;</span>
    return null;
  }, [mentionMap]);
&nbsp;
  ...
  const macroById = useMemo(() =&gt; {
    const map = {};
    const list = Array.isArray(macroSeries) ? macroSeries : <span class="branch-1 cbranch-no" title="branch not covered" >[];</span>
    for (const s of list) {
<span class="cstat-no" title="statement not covered" >      if (!s?.id) <span class="cstat-no" title="statement not covered" >continue;</span></span>
<span class="cstat-no" title="statement not covered" >      map[s.id] = s;</span>
    }
    return map;
  }, [macroSeries]);
&nbsp;
...
&nbsp;
  const handleSearchKeyDown = (e) =&gt; {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (e.key !== "Enter") <span class="cstat-no" title="statement not covered" >return;</span>
    addTicker(searchTerm);
  };
&nbsp;
  const removeTicker = <span class="fstat-no" title="function not covered" >(t</span>icker) =&gt; {
<span class="cstat-no" title="statement not covered" >    setSelectedTickers(selectedTickers.filter(<span class="fstat-no" title="function not covered" >(t</span>) =&gt; <span class="cstat-no" title="statement not covered" >t !== ticker)</span>);</span>
  };
&nbsp;
  return (
    &lt;AppShell&gt;
      &lt;div className="dashboard"&gt;
        ...
        &lt;StatSummary
          meta={meta}
          rawData={Array.isArray(rawData) ? rawData : <span class="branch-1 cbranch-no" title="branch not covered" >[]}</span>
        /&gt;
&nbsp;
...
&nbsp;
              ...
              ) : <span class="branch-1 cbranch-no" title="branch not covered" >topIndexFund ? (</span>
                &lt;&gt;
...
<span class="branch-1 cbranch-no" title="branch not covered" >                &lt;&gt;</span>
                  &lt;table className="mini-table"&gt;
                    ...
                    &lt;/thead&gt;
                    &lt;tbody&gt;
                      {priceRows.map(<span class="fstat-no" title="function not covered" >(r</span>ow) =&gt; (
<span class="cstat-no" title="statement not covered" >                        &lt;tr key={row.ticker}&gt;</span>
                          &lt;td&gt;{row.ticker}&lt;/td&gt;
                          &lt;td&gt;
                  ...
                  &lt;div className="macro-grid"&gt;
                    &lt;div className="macro-pill"&gt;
                      ...
                      &lt;div className="macro-value"&gt;
                        {cpi?.latest != null ? <span class="branch-0 cbranch-no" title="branch not covered" >cpi.latest.toFixed(1) : "</span>—"}
                      &lt;/div&gt;
...
&nbsp;
                    &lt;div className="macro-pill"&gt;
                      ...
                      &lt;div className="macro-value"&gt;
                        {unrate?.latest != null
                          ? <span class="branch-0 cbranch-no" title="branch not covered" >`${unrate.latest.toFixed(1)}%`</span>
                          : "—"}
                      &lt;/div&gt;
                      &lt;div className="macro-meta"&gt;
                    ...
                    &lt;div className="macro-pill"&gt;
                      ...
                      &lt;div className="macro-value"&gt;
                        {fedFunds?.latest != null
                          ? <span class="branch-0 cbranch-no" title="branch not covered" >fedFunds.latest.toFixed(2)</span>
                          : "—"}
                      &lt;/div&gt;
                      &lt;div className="macro-meta"&gt;
                        ...
                        {suggestions.map((t) =&gt; (
                          &lt;li key={t}&gt;
                            &lt;button
                              ...
                              onClick={<span class="fstat-no" title="function not covered" >() =&gt; <span class="cstat-no" title="statement not covered" >a</span>ddTicker(t)}</span>
                            &gt;
                              {t}
                            &lt;/button&gt;
                          &lt;/li&gt;
...
&nbsp;
                    &lt;small className="ticker-input-help"&gt;
                      ...
                      {allTickers.length &gt; 8 ? <span class="branch-0 cbranch-no" title="branch not covered" >", …" : "</span>"}
                    &lt;/small&gt;
                  &lt;/div&gt;
&nbsp;
                    ...
                    &lt;div className="ticker-chip-row"&gt;
                      {selectedTickers.map((ticker) =&gt; (
                        &lt;button
                          ...
                          onClick={<span class="fstat-no" title="function not covered" >() =&gt; <span class="cstat-no" title="statement not covered" >r</span>emoveTicker(ticker)}</span>
                        &gt;
                          {ticker}
...
&nbsp;
              {joinedMeta &amp;&amp; (
                &lt;div className="chart-meta"&gt;
                  Source: reddit + news{" · "}
                  Snapshot window:{" "}
                  {joinedMeta.windowDescription ?? <span class="branch-1 cbranch-no" title="branch not covered" >"Latest pull"}</span>
                &lt;/div&gt;
              )}
            &lt;/div&gt;
          &lt;/section&gt;
...
&nbsp;
        {meta &amp;&amp; (
<span class="branch-1 cbranch-no" title="branch not covered" >          &lt;div className="dashboard-last-updated"&gt;</span>
