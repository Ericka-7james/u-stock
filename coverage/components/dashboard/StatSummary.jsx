...
<head>
    <title>Code coverage report for components/dashboard/StatSummary.jsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">components/dashboard</a> StatSummary.jsx</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">// src/components/dashboard/StatSummary.jsx
import { Link } from "react-router-dom";
&nbsp;
export default function StatSummary({ meta, rawData }) {
  const list = Array.isArray(rawData) ? rawData : <span class="branch-1 cbranch-no" title="branch not covered" >[];</span>
  const totalMentions = list.reduce((sum, item) =&gt; sum + (item.count || <span class="branch-1 cbranch-no" title="branch not covered" >0), 0</span>);
