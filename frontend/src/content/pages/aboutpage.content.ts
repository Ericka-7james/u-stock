...
export const ABOUT_PAGE_COPY = {
  ...
  intro: {
    primary:
      "Lucent Financial (U-Stock) is a market intelligence workspace designed to turn noisy price action into a clean decision workflow: discover what’s moving, add context, then act with intent.",
    secondary:
