    ...
    <AppShell>
      ...
      <section className="about-hero-card">
        <div className="about-hero-left">
          <h1 className="page-title">About Lucent Financial</h1>
          <p className="muted about-tagline">Access to smarter financial decisions.</p>
        ...
        {/* LOGO takes the entire right side of the hero */}
        <div className="about-hero-right" aria-label="Lucent Financial logo">
          <div className="about-hero-logoPanel">
            <img src={lucentLogo} alt="Lucent Financial logo" className="about-hero-logo" />
          </div>
        </div>
      </section>
      ...
      <section className="about-grid">
        ...
        {/* Move the "right side" content down here to fill bottom space */}
        <article className="about-card">
